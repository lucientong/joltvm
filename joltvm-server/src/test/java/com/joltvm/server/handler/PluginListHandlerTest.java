...
class PluginListHandlerTest {

    @Test
    void returns200WithEmptyPluginList() {
        PluginListHandler handler = new PluginListHandler(new PluginLifecycleManager(new HttpRouter()));
        FullHttpRequest request = new DefaultFullHttpRequest(
                HttpVersion.HTTP_1_1, HttpMethod.GET, "/api/plugins");
