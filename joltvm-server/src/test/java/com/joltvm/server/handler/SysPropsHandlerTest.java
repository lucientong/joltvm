...
class SysPropsHandlerTest {

    @Test
    void returns200WithProperties() {
        SysPropsHandler handler = new SysPropsHandler(new JvmInfoService());
        FullHttpRequest request = new DefaultFullHttpRequest(
                HttpVersion.HTTP_1_1, HttpMethod.GET, "/api/jvm/sysprops");
