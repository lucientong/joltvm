...
/**
 * Handler for {@code DELETE /api/watch/{id}} — deletes a watch session.
 */
public class WatchDeleteHandler implements RouteHandler {

    private final WatchService watchService;

    public WatchDeleteHandler(WatchService watchService) {
    ...
    public FullHttpResponse handle(FullHttpRequest request, Map<String, String> pathParams) {
        ...
        return HttpResponseHelper.json(Map.of("deleted", true, "id", id));
    }
}
