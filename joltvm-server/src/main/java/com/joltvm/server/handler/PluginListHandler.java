...
/**
 * Handler for {@code GET /api/plugins} — lists all loaded plugins.
 */
public class PluginListHandler implements RouteHandler {

    private final PluginLifecycleManager pluginManager;

    public PluginListHandler(PluginLifecycleManager pluginManager) {
        this.pluginManager = pluginManager;
    }

    @Override
    public FullHttpResponse handle(FullHttpRequest request, Map<String, String> pathParams) {
        return HttpResponseHelper.json(pluginManager.listPlugins());
    }
}
