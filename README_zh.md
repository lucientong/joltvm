...
> JoltVM 正在积极开发中。Phase 1（Agent 骨架 + Attach API）和 Phase 2（Netty Web Server + REST API）已完成。完整计划参见[路线图](#-路线图)。
...
| `joltvm-server` | 嵌入式 Netty HTTP 服务器，提供 REST API（类列表、详情、反编译） | ✅ Phase 2 |
